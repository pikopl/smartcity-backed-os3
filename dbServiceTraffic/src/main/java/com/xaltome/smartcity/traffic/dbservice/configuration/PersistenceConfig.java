 ...
 * 
 */
package com.xaltome.smartcity.traffic.dbservice.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = { "com.xaltome.smartcity.traffic.dbservice.repository" })
...
public class PersistenceConfig {
	...
	public EntityManagerFactory entityManagerFactory(final DataSource dataSource, final Environment env) {
		...
		entityManagerFactoryBean.setPackagesToScan("com.xaltome.smartcity.traffic.dbservice");
